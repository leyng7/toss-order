    ...
    <v-row>
      <v-col v-for="post in posts" :key="post.id" cols="12" sm="12" md="6" xl="4">
        <v-card :to="`/posts/${post.id}`" class="card">
          <v-img src="https://post-phinf.pstatic.net/MjAxOTA0MjZfMjc2/MDAxNTU2MjE2Njc1NjAz.5GjTVBEPY0kd2SExs3uiK2eeZ1K6pCae4MwViLxf8rcg.BN2Tr6BXUaFG_IJJOB4pSFLRdHqprgQxk-ugh-W0uZ4g.JPEG/KakaoTalk_20190426_032248653.jpg?type=w800_q75"
                 :alt="post.title"
                 height="300"
                 :cover="true"
                 class="thumbnail"
